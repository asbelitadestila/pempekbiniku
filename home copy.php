...
<body class="bg-[#FFFAE7] text-white text-center">
    ...
    <nav class="bg-red-600 flex justify-between items-center px-[7%] py-[0.2rem] fixed top-0 left-0 right-0 z-[9999]">
        ...
        <div class="navbar-icon flex">
            <div class="relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                <svg class="absolute w-6 h-6 text-gray-400 -left-1" fill="none" stroke="currentColor"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                ...
                <a href="keranjang.php" class="relative">
                    ...
                    <?php
                        ...
                        ?>
                    <span
                        class="absolute -top-2 -right-2 bg-white text-crimson rounded-full text-xs w-5 h-5 flex items-center justify-center"
                        id="jumlah_pesanan"><?php echo $data['total']; ?></span>
                </a>
                <?php } ?>
            </div>
        ...
        <div
            class="user absolute top-full right-[-100%] h-[15vh] w-40 px-4 bg-white text-black text-center rounded shadow-md transition-all duration-300">
            <?php if (isset($_SESSION['username'])) { ?>
            <li class="list-none my-5"><a href="profil.php"
                    class="no-underline text-xl text-crimson font-robotoMedium">Profil</a></li>
            <li class="list-none my-5"><a href="admin/logout.php"
                    class="no-underline text-xl text-crimson font-robotoMedium">Logout</a></li>
            <?php } else { ?>
            <li class="list-none my-5"><a href="admin/login.php"
                    class="no-underline text-xl text-crimson font-robotoMedium">Login</a></li>
            <li class="list-none my-5"><a href="daftar.php"
                    class="no-underline text-xl text-crimson font-robotoMedium">Daftar</a></li>
            <?php } ?>
        </div>
    ...
    <div class="container mx-auto">
        ...
        document.getElementById('btn-user').addEventListener('click', function() {
            ...
            document.querySelector('.user.active') ?
                document.querySelector('.user').style.right = '15px' :
                document.querySelector('.user').style.right = '-100%';
        });
